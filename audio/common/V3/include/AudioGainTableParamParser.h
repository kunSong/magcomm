...
class GainTableParamParser
{
    ...
    private:
        ...
        template<class T>
        status_t getParam(ParamUnit *_paramUnit, T *_param, char *_paramName);
        status_t getParam(ParamUnit *_paramUnit, std::string *_param, char *_paramName);

        template<class T>
        status_t getParamVector(ParamUnit *_paramUnit, std::vector<T> *_param, char *_paramName);
        status_t getParamVector(ParamUnit *_paramUnit, std::vector<std::string> *_param, char *_paramName);
