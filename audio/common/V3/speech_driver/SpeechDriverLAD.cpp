...
status_t SpeechDriverLAD::SetDynamicSpeechParameters(const int type, const void *param_arg)
{
    ...
    switch (type)
    {
        case AUDIO_TYPE_SPEECH:
            ...
            {
                ALOGD("%s(), pPackedSphParamUnit[%d] = 0x%x", __FUNCTION__, u4I, *((uint16_t *)pPackedSphParamUnit + u4I));
        ...
        case AUDIO_TYPE_SPEECH_DMNR:
            ...
            for (u4I = 0; u4I<size_byte >> 1; u4I++)
            {
                ALOGD("%s(), DMNR pPackedSphParamUnit[%d] = 0x%x", __FUNCTION__, u4I, *((uint16_t *)pPackedSphParamUnit + u4I));
        ...
        case AUDIO_TYPE_SPEECH_GENERAL:
            ...
            for (u4I = 0; u4I<size_byte >> 1; u4I++)
            {
                ALOGD("%s(), General pPackedSphParamUnit[%d] = 0x%x", __FUNCTION__, u4I, *((uint16_t *)pPackedSphParamUnit + u4I));
            }
            SetVariousKindsOfSpeechParameters(pPackedSphParamUnit, size_byte, MSG_A2M_EM_DYNAMIC_SPH);
            break;
        case AUDIO_TYPE_SPEECH_MAGICLARITY:
            ...
            for (u4I = 0; u4I<size_byte >> 1; u4I++)
            {
                ALOGD("%s(), MagiClairity pPackedSphParamUnit[%d] = 0x%x", __FUNCTION__, u4I, *((uint16_t *)pPackedSphParamUnit + u4I));
            }
            SetVariousKindsOfSpeechParameters(pPackedSphParamUnit, size_byte, MSG_A2M_EM_DYNAMIC_SPH);
            break;
        default:
