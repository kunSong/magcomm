...
STATIC_METADATA2_BEGIN(DEVICE, TUNING_3A, SENSOR_DRVNAME_GC5025_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.control
//------------------------------------------------------------------------------
    //==========================================================================
...
// not-support: CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_SOLARIZE, MUINT8)
        ...
        CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_SEPIAGREEN, MUINT8)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_SEPIABLUE, MUINT8)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_NASHVILLE, MUINT8)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_HEFE, MUINT8)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_VALENCIA, MUINT8)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_XPROII, MUINT8)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_LOFI, MUINT8)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_SIERRA, MUINT8)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_KELVIN, MUINT8)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_WALDEN, MUINT8)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_EFFECT_MODE_F1977, MUINT8)
    CONFIG_METADATA_END()
    //==========================================================================
    ...
    CONFIG_METADATA_END()
    //==========================================================================weiyawei add MTK_CONTROL_AVAILABLE_MODES
    ...
    CONFIG_METADATA_END()
    //========================================================================== weiyawei add MTK_CONTROL_AWB_LOCK_AVAILABLE
    ...
    CONFIG_METADATA_END()
    //==========================================================================weiyawei add MTK_SHADING_AVAILABLE_MODES
    ...
    CONFIG_METADATA_END()
    //==========================================================================weiyawei add MTK_STATISTICS_INFO_AVAILABLE_LENS_SHADING_MAP_MODES
