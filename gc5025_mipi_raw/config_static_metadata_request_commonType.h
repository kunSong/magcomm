...
STATIC_METADATA2_BEGIN(DEVICE, REQUEST, SENSOR_DRVNAME_GC5025_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
...
//        CONFIG_ENTRY_VALUE(MTK_REQUEST_AVAILABLE_CAPABILITIES_RAW, MUINT8)
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_RESULT_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_SHADING_MODE, MINT32)
	    CONFIG_ENTRY_VALUE(MTK_SHADING_AVAILABLE_MODES, MINT32)//weiyawei add
	    CONFIG_ENTRY_VALUE(MTK_STATISTICS_INFO_AVAILABLE_LENS_SHADING_MAP_MODES, MINT32)//weiyawei add
        CONFIG_ENTRY_VALUE(MTK_STATISTICS_FACE_DETECT_MODE, MINT32)
	...
	CONFIG_ENTRY_VALUE(MTK_CONTROL_AE_LOCK_AVAILABLE, MINT32)//weiyawei add 
	CONFIG_ENTRY_VALUE(MTK_CONTROL_AVAILABLE_MODES, MINT32)//weiyawei add 
	...
	CONFIG_ENTRY_VALUE(MTK_CONTROL_AWB_LOCK_AVAILABLE, MINT32)//weiyawei add
