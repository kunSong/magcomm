...
STATIC_METADATA2_BEGIN(DEVICE, SCALER, SENSOR_DRVNAME_GC5025_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.scaler
//------------------------------------------------------------------------------
    //==========================================================================
...
//    { "cropRegion",                    TYPE_INT32  },
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS)//new hidden
                ...
                CONFIG_ENTRY_VALUE(4656, MINT32)
                CONFIG_ENTRY_VALUE(3492, MINT32)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT32)
                CONFIG_ENTRY_VALUE( 192, MINT32)
                CONFIG_ENTRY_VALUE( 144, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT32)
                CONFIG_ENTRY_VALUE( 192, MINT32)
                CONFIG_ENTRY_VALUE( 108, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, MINT32) //13mp 16:9
                CONFIG_ENTRY_VALUE(4096, MINT32)
                CONFIG_ENTRY_VALUE(2304, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
...
#if 1
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT32) //13mp 4:3
                CONFIG_ENTRY_VALUE(4096, MINT32)
                CONFIG_ENTRY_VALUE(3072, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT32) //13mp 16:9
                CONFIG_ENTRY_VALUE(4096, MINT32)
                CONFIG_ENTRY_VALUE(2304, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT32) //8mp 4:3
                CONFIG_ENTRY_VALUE(3264, MINT32)
                CONFIG_ENTRY_VALUE(2448, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT32) //8mp 16:9
                CONFIG_ENTRY_VALUE(3840, MINT32)
                CONFIG_ENTRY_VALUE(2160, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_MIN_FRAME_DURATIONS)//new hidden
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT64)
                CONFIG_ENTRY_VALUE( 192, MINT64)
                CONFIG_ENTRY_VALUE( 144, MINT64)
                CONFIG_ENTRY_VALUE(33333333, MINT64)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT64)
                CONFIG_ENTRY_VALUE( 192, MINT64)
                CONFIG_ENTRY_VALUE( 108, MINT64)
                CONFIG_ENTRY_VALUE(33333333, MINT64)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, MINT64) //13mp 16:9
                CONFIG_ENTRY_VALUE(4096, MINT64)
                CONFIG_ENTRY_VALUE(2304, MINT64)
                CONFIG_ENTRY_VALUE(66666666, MINT64)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT64) //13mp 4:3
                CONFIG_ENTRY_VALUE(4096, MINT64)
                CONFIG_ENTRY_VALUE(3072, MINT64)
                CONFIG_ENTRY_VALUE(66666666, MINT64)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT64) //13mp 16:9
                CONFIG_ENTRY_VALUE(4096, MINT64)
                CONFIG_ENTRY_VALUE(2304, MINT64)
                CONFIG_ENTRY_VALUE(66666666, MINT64)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT64) //8mp 4:3
                CONFIG_ENTRY_VALUE(3264, MINT64)
                CONFIG_ENTRY_VALUE(2448, MINT64)
                CONFIG_ENTRY_VALUE(50000000, MINT64)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT64) //8mp 16:9
                CONFIG_ENTRY_VALUE(3840, MINT64)
                CONFIG_ENTRY_VALUE(2160, MINT64)
                CONFIG_ENTRY_VALUE(50000000, MINT64)
